...
export default function LargeProjectCard(
  { title, description, imageUrl, projectUrl, pictureInLeft = true, releaseDate }:
  { title: string; description: string; imageUrl: string; projectUrl: string, pictureInLeft?: boolean, releaseDate?: string }
) {
  ...
  return (
    <div className={`glass-container mx-4 lg:mx-20 flex flex-col ${isUpcoming ? 'upcoming-project' : ''} ${pictureInLeft ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
